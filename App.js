...
import BlockRooms from './src/screens/admin/BlockRooms';
import CotDetails from './src/screens/admin/CotDetails';
import ManageStudentAccounts from './src/screens/admin/ManageStudentAccounts';
        ...
        !token && (
          <NavigationContainer independent={true} initialRouteName={"HostelsBlocks"}>
            <Drawer.Navigator>
              ...
              <Drawer.Screen name="Development Team" component={DevelopmentTeam} options={{drawerLabel:"Development Team", drawerIcon: ({ size }) => (<Icon name='users-line' size={size} style={{ width: 30, textAlign: 'center' }} color='gray' />) }} />
              <Drawer.Screen name="Gallery" component={Gallery} options={{drawerLabel:"Gallery", drawerIcon: ({ size }) => (<Icon name='image' size={size} style={{ width: 30, textAlign: 'center' }} color='gray' />) }} />
              ...
              <Drawer.Screen name="Reset Password Email Sent" component={ResetPasswordMailSent} options={{drawerItemStyle:{display:'none'}}} />
              <Drawer.Screen name="Reset Password" component={ResetPassword} options={{drawerItemStyle:{display:'none'}}} />
              {/* <Drawer.Screen name="OtpInput" component={OtpInput} options={{drawerItemStyle:{display:'none'}}} /> */}
              <Drawer.Screen name='Reset Password Success' component={ResetPasswordSuccess} options={{drawerItemStyle:{display:'none'}}} />
              <Drawer.Screen name="Forgot Password" component={ForgotPassword} options={{drawerItemStyle:{display:'none'}}} />
        ...
        token && user && user.accountType==='ADMIN' && (
          <NavigationContainer independent={true} initialRouteName='Manage Official Accounts'>
            <Drawer.Navigator>
                ...
                <Drawer.Screen name="Odd Sem Registation Applications" component={StudentRegistrationApplications} options={{drawerLabel:"Odd Sem Registation Applications", headerRight: () => (<TouchableOpacity onPress={() => setLogoutModalVisible(true)} style={{ marginRight: 15 }}><Icon name='right-from-bracket' size={25} color='gray' /></TouchableOpacity>), drawerIcon: ({ size }) => (<Icon name='address-card' size={size} style={{ width: 30, textAlign: 'center' }} color='gray' />) }} />
                <Drawer.Screen name="Even Sem Registation Applications" component={EvenSemRegistrationApplications} options={{drawerLabel:"Even Sem Registation Applications", headerRight: () => (<TouchableOpacity onPress={() => setLogoutModalVisible(true)} style={{ marginRight: 15 }}><Icon name='right-from-bracket' size={25} color='gray' /></TouchableOpacity>), drawerIcon: ({ size }) => (<Icon name='address-card' size={size} style={{ width: 30, textAlign: 'center' }} color='gray' />) }} />
                <Drawer.Screen name="Manage Student Accounts" component={ManageStudentAccounts} options={{drawerLabel:"Manage Student Accounts", headerRight: () => (<TouchableOpacity onPress={() => setLogoutModalVisible(true)} style={{ marginRight: 15 }}><Icon name='right-from-bracket' size={25} color='gray' /></TouchableOpacity>), drawerIcon: ({ size }) => (<Icon name='child' size={size} style={{ width: 30, textAlign: 'center' }} color='gray' />) }} />
                ...
                <Drawer.Screen name="Gallery" component={Gallery} options={{drawerLabel:"Gallery",headerRight: () => (<TouchableOpacity onPress={() => setLogoutModalVisible(true)} style={{ marginRight: 15 }}><Icon name='right-from-bracket' size={25} color='gray' /></TouchableOpacity>), drawerIcon: ({ size }) => (<Icon name='image' size={size} style={{ width: 30, textAlign: 'center' }} color='gray' />) }} />
                ...
                <Drawer.Screen name="Block Rooms" component={BlockRooms} options={{drawerItemStyle:{display:'none'},headerRight: () => (<TouchableOpacity onPress={() => setLogoutModalVisible(true)} style={{ marginRight: 15 }}><Icon name='right-from-bracket' size={25} color='gray' /></TouchableOpacity>)}} />
                <Drawer.Screen name="Cot Details" component={CotDetails} options={{drawerItemStyle:{display:'none'},headerRight: () => (<TouchableOpacity onPress={() => setLogoutModalVisible(true)} style={{ marginRight: 15 }}><Icon name='right-from-bracket' size={25} color='gray' /></TouchableOpacity>)}} />
                <Drawer.Screen name="Change Student Cot" component={ChangeStudentCot} options={{drawerItemStyle:{display:'none'},headerRight: () => (<TouchableOpacity onPress={() => setLogoutModalVisible(true)} style={{ marginRight: 15 }}><Icon name='right-from-bracket' size={25} color='gray' /></TouchableOpacity>)}} />
            </Drawer.Navigator>
        ...
        token && user && user.accountType==='STUDENT' && (
          <NavigationContainer independent={true} initialRouteName='Dashboard'>
            <Drawer.Navigator>
                ...
                <Drawer.Screen name="Generate Mess Receipt" component={GenerateMessReceipt} options={{drawerLabel:"Generate Mess Receipt",headerRight: () => (<TouchableOpacity onPress={() => setLogoutModalVisible(true)} style={{ marginRight: 15 }}><Icon name='right-from-bracket' size={25} color='gray' /></TouchableOpacity>), drawerIcon: ({ size }) => (<Icon name='cash-register' size={size} style={{ width: 30, textAlign: 'center' }} color='gray' />) }} />
                <Drawer.Screen name="Mess Receipts History" component={MessReceiptsHistory} options={{drawerLabel:"Mess Receipts History",headerRight: () => (<TouchableOpacity onPress={() => setLogoutModalVisible(true)} style={{ marginRight: 15 }}><Icon name='right-from-bracket' size={25} color='gray' /></TouchableOpacity>), drawerIcon: ({ size }) => (<Icon name='receipt' size={size} style={{ width: 30, textAlign: 'center' }} color='gray' />) }} />  
                ...
                <Drawer.Screen name="Development Team" component={DevelopmentTeam} options={{drawerLabel:"Development Team",headerRight: () => (<TouchableOpacity onPress={() => setLogoutModalVisible(true)} style={{ marginRight: 15 }}><Icon name='right-from-bracket' size={25} color='gray' /></TouchableOpacity>), drawerIcon: ({ size }) => (<Icon name='users-line' size={size} style={{ width: 30, textAlign: 'center' }} color='gray' />) }} />
                <Drawer.Screen name="Detailed Mess Menu" component={DetailedMessMenu} options={{drawerItemStyle:{display:'none'},headerRight: () => (<TouchableOpacity onPress={() => setLogoutModalVisible(true)} style={{ marginRight: 15 }}><Icon name='right-from-bracket' size={25} color='gray' /></TouchableOpacity>)}} />
                <Drawer.Screen name="Give Mess Feedback" component={GiveMessFeedback} options={{drawerItemStyle:{display:'none'},headerRight: () => (<TouchableOpacity onPress={() => setLogoutModalVisible(true)} style={{ marginRight: 15 }}><Icon name='right-from-bracket' size={25} color='gray' /></TouchableOpacity>)}} />
            </Drawer.Navigator>
            <LogoutModal logoutModalVisible={logoutModalVisible} setLogoutModalVisible={setLogoutModalVisible} animationType={"fade"} transparent={true} />
          </NavigationContainer>
        )
