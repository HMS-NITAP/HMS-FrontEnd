  ...
  return (
    <View style={{width:"100%", display:"flex", flexDirection:"column", justifyContent:"center",alignItems:"center",gap:15}}>
        ...
        <View style={{width:"100%", backgroundColor:"#d8f3dc", borderRadius:20, paddingHorizontal:15, paddingVertical:15}}>
            <Text style={{textAlign:"center", fontSize:15, color:"black"}}>Your hostel registration application has been successfully submitted to the hostel office and is currently under review. You will receive a confirmation email at your institute email address, <Text style={{fontWeight:"800"}}>422250@student.nitandhra.ac.in</Text>, once all details have been validated. You will be able to log in once your details are verified. Thank you for your patience.</Text>
        </View>
        <MainButton text={"Done"} onPress={() => navigation.navigate("Login")} />
    </View>
  )
}
